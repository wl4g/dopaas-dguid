 ...
 */
package com.wl4g.dguid.snowflake;
...
public class SnowflakeIdWorker {
	...
	public String parseUID(String uid) {
		...
		// 格式化输出
		return String.format(MSG_UID_PARSE, uid, date, Integer.valueOf(workerId, 2), Integer.valueOf(dataCenterId, 2),
				Integer.valueOf(sequence, 2));
	}
