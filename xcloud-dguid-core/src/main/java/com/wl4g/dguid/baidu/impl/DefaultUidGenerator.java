...
import com.wl4g.dguid.baidu.utils.DateUtils;
import com.wl4g.dguid.worker.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
	...
	/**
	 * Customer epoch, unit as second. For example 2016-05-20 (ms:
	 * 1463673600000)
	 */
	...
	public String parseUID(long uid) {
		...
		// format as string
		return String.format("{\"UID\":\"%d\",\"timestamp\":\"%s\",\"workerId\":\"%d\",\"sequence\":\"%d\"}", uid, thatTimeStr,
				workerId, sequence);
	}
